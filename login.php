...
<body class="login-page" style="background-color: #2E2E2E; background-color: black;">
    <div class="login-box">
        <div class="logo">
                ...
                <form id="sign_in" method="POST">
                    ...
                    <div class="row">
                        <div class="col-xs-4 pull-right">
                            <a href="signup.php" class="btn btn-block bg-green waves-effect" role="button" name="btn-signup" data-type="success">SIGN UP</a>
                        </div>
                        <div class="col-xs-4 pull-right">
